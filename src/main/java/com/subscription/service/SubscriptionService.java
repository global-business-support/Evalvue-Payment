...
public class SubscriptionService {
	...
	public SubscriptionResponseDTO createSubscriptionAndInsertDB(String PlanId, int MonthlyCycle, UserRequest user)
			throws Exception, RazorpayException {
...
//      
	...
	public SubscriptionResponseDTO FecthSubcriptionDetails(String subscriptionId)
	...
	public JSONObject VerificationService(String razorpaySuscriptionId, String paymentId, Long userId,
			Long organizationId) throws RazorpayException, ParseException {
