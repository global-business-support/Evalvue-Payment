...
public interface PaymentRepository extends JpaRepository<PaymentResponseEntity, Long> {
	...
	public void insertPaymentResponse(@Param("razorpayPaymentId") String razorpayPaymentId,
			@Param("razorpayOrderId") String razorpayOrderId,
			@Param("razorPaySubscriptionId") String razorPaySubscriptionId, @Param("userId") Long userId,
			@Param("organizationId") Long organizationId, @Param("paymentStatusId") int paymentStatusId,
			@Param("amount") int amount, @Param("paymentMode") String paymentMode, @Param("userEmail") String userEmail,
			@Param("contact") String contact, @Param("createdOn") Date createdOn,
